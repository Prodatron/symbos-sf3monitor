...
App_BnkNum  db 0                    ;*reserved*                         POST bank number
            db "SYMBiFACE III monitor":ds 3:db 0 ;name
...
prgmemtab   db "SymExe10"           ;SymbOS-EXE-identifier              POST table reserved memory areas
            ...
            dw 0                    ;additional data memory [link data]
            dw 0                    ;additional transfer memory
            ds 26                   ;*reserved*
            db 0,3                  ;required OS version (3.0)
prgicnsml   db 2,8,8,#75,#EA,#38,#C1,#74,#E2,#29,#C1,#74,#6A,#38,#C1,#74,#E2,#08,#01
...
use_SyDesktop_DSKSTP    equ 0   ;Stops desktop
use_SyDesktop_DSKCNT    equ 0   ;Continues desktop
use_SyDesktop_DSKPNT    equ 0   ;Clears desktop
